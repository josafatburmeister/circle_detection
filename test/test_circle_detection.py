...
class TestCircleDetection:
    ...
    def test_circle_one_perfect_fit_and_one_noisy_circle(self):
        ...
        circle_detector = CircleDetection(bandwidth=bandwidth)
        ...
        assert len(circle_detector.fitting_losses) == 1
        ...
        assert len(circle_detector.fitting_losses) == 2
        ...
        np.testing.assert_almost_equal(expected_fitting_losses, circle_detector.fitting_losses, decimal=5)
    ...
    def test_several_noisy_circles(self):
        ...
        circle_detector = CircleDetection(bandwidth=0.05, min_fitting_score=5)
        ...
        assert len(circle_detector.circles) == len(circle_detector.fitting_losses)
    ...
    def test_filtering_circumferential_completeness_index(self, pass_max_dist: bool):
        ...
        assert len(circle_detector.fitting_losses) == 0
    ...
    def test_batch_processing(self):
        ...
        assert len(circle_detector.fitting_losses) == num_batches
    ...
    def test_invalid_detection_parameters(self, kwargs: Dict[str, Any]):
        ...
        circle_detector = CircleDetection(bandwidth=0.01)
